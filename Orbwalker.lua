...
function Damage:__init()
    self.heroPassives = {
        ...
        ["Kaisa"] = function(args) local source = args.source
            ...
            local damage = ({4, 4, 6, 6, 6, 8, 8, 8, 10, 10,
                12, 12, 12, 14, 14, 14, 16, 16})[source.level] +
                ({1, 1, 1, 2.75, 2.75, 2.75, 2.75, 4.5, 4.5, 4.5, 4.5,
                6.25, 6.25, 6.25, 6.25, 8, 8, 8})[source.level] * count
                + (0.125 + 0.025 * (count + 1)) * source.ability_power
            if count == 4 then damage = damage +
                (0.15 + (0.05 * source.ability_power / 100)) *
        ...
        ["Kayle"] = function(args) local source = args.source
            ...
            if source:has_buff("JudicatorRighteousFury") then
                args.rawMagical = args.rawMagical + (7 + 0.5 * lvl +
        ...
        ["MasterYi"] = function(args) local source = args.source
            ...
            local lvl = spellbook:get_spell_slot(SLOT_E).level
            args.trueDamage = args.trueDamage + 22 + 8 *
        ...
        ["TahmKench"] = function(args) local source = args.source
            args.rawMagical = args.rawMagical + 4.94 + 3.06 * source.level
                + 0.025 * (source.max_health - (640 + 109 * source.level))
        end,
        ...
        ["Zed"] = function(args) local source = args.source
        ...
        ["Zeri"] = function(args) local source = args.source
            ...
            local lvl = spellbook:get_spell_slot(SLOT_Q).level
            args.rawPhysical = 5 + 2 * lvl + (1.075 +
                0.025 * lvl) * myHero.total_attack_damage
        end,
...
function Data:__init()
    ...
    self.blockAttackBuffs = {
        ...
        ["Kennen"] = {"KennenLightningRush"}, ["KogMaw"] = {"KogMawIcathianSurprise"},
        ["Lillia"] = {"LilliaQ"}, ["Lucian"] = {"LucianR"}, ["Pyke"] = {"PykeQ"},
    ...
    self.resetAttackNames = {
        ...
        ["NautilusPiercingGaze"] = true, ["Takedown"] = true, ["RekSaiQ"] = true,
        ["RenektonPreExecute"] = true, ["RengarQ"] = true, ["RengarQEmp"] = true,
        ["RivenTriCleave"] = true, ["SejuaniE"] = true, ["SettQ"] = true,
...
function TargetSelector:__init(data)
    ...
    self.priorityList = {
        ...
        ["Brand"] = 4, ["Braum"] = 1, ["Caitlyn"] = 5, ["Camille"] = 3, ["Cassiopeia"] = 4,
        ["Chogath"] = 1, ["Corki"] = 5, ["Darius"] = 2, ["Diana"] = 4, ["DrMundo"] = 1,
        ["Draven"] = 5, ["Ekko"] = 4, ["Elise"] = 3, ["Evelynn"] = 4, ["Ezreal"] = 5,
        ["FiddleSticks"] = 3, ["Fiora"] = 3, ["Fizz"] = 4, ["Galio"] = 1, ["Gangplank"] = 4,
        ...
        ["Neeko"] = 4, ["Nidalee"] = 4, ["Nocturne"] = 4, ["Nunu"] = 2, ["Olaf"] = 2,
        ["Orianna"] = 4, ["Ornn"] = 2, ["Pantheon"] = 3, ["Poppy"] = 2, ["Pyke"] = 4,
        ["Qiyana"] = 4, ["Quinn"] = 5, ["Rakan"] = 3, ["Rammus"] = 1, ["RekSai"] = 2,
        ["Rell"] = 5, ["Renata"] = 3, ["Renekton"] = 2, ["Rengar"] = 4, ["Riven"] = 4,
        ["Rumble"] = 4, ["Ryze"] = 4, ["Samira"] = 5, ["Sejuani"] = 2, ["Senna"] = 5,
        ["Seraphine"] = 4, ["Sett"] = 2, ["Shaco"] = 4, ["Shen"] = 1, ["Shyvana"] = 2,
        ["Singed"] = 1, ["Sion"] = 1, ["Sivir"] = 5, ["Skarner"] = 2, ["Sona"] = 3,
        ["Soraka"] = 3, ["Swain"] = 3, ["Sylas"] = 4, ["Syndra"] = 4, ["TahmKench"] = 1,
        ["Taliyah"] = 4, ["Talon"] = 4, ["Taric"] = 1, ["Teemo"] = 4, ["Thresh"] = 1,
        ["Tristana"] = 5, ["Trundle"] = 2, ["Tryndamere"] = 4, ["TwistedFate"] = 4,
        ["Twitch"] = 5, ["Udyr"] = 2, ["Urgot"] = 2, ["Varus"] = 5, ["Vayne"] = 5,
        ["Veigar"] = 4, ["Velkoz"] = 4, ["Vex"] = 4, ["Vi"] = 2, ["Viego"] = 4,
        ["Viktor"] = 4, ["Vladimir"] = 3, ["Volibear"] = 2, ["Warwick"] = 2, ["Xayah"] = 5,
        ["Xerath"] = 4, ["Xinzhao"] = 3, ["Yasuo"] = 4, ["Yone"] = 4, ["Yorick"] = 2,
        ["Yuumi"] = 3, ["Zac"] = 1, ["Zed"] = 4, ["Zeri"] = 5, ["Ziggs"] = 4,
        ["Zilean"] = 3, ["Zoe"] = 4, ["Zyra"] = 2
    }
    self.sortingModes = {
...
function Orbwalker:IsCollidingWindwall(endPos)
    ...
    local input = {source = myHero, speed = speed,
        delay = windup, collision = {"wind_wall"}}
...
function Orbwalker:GetOrbwalkerTarget(mode)
    ...
    if mode >= 2 and mode <= 5 and support == 0 then
        -- sometimes we last hit too early...
        -- and we have to fix it somehow :/
        self.waveMinions:ForEach(function(m)
            if m.killable and m.delayPred > 50
            and m.gameObject.health > m.damage
            then m.killable = false end end)
...
function Orbwalker:UpdateMinionData()
    ...
    self.waveMinions = waveMinions:Select(function(m)
        ...
        local clearPred = prediction:get_lane_clear_health_prediction(m, timeToHit + wait)
        local delayPred = prediction:get_lane_clear_health_prediction(m, timeToHit + 0.2)
        ...
        local killable = killPred > 0 and healthPred > 0 and healthPred <= damage
        return {damage = damage, gameObject = m, killable = killable, timeToHit =
            timeToHit, clearPred = clearPred, delayPred = delayPred, freezePred =
            freezePred, healthPred = healthPred, killPred = killPred}
    end)
    table.sort(self.waveMinions, function(a, b)
        ...
        local a_hp, b_hp = a.delayPred, b.delayPred
